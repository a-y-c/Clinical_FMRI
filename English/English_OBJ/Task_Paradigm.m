...
for i = 1:DATA.BlockTotalNum
    ...
    % Draw White Screen after .45 Seconds
    WaitSecs(.45);
    DrawWhiteScreen(WSS, RSS);
    % Wait till Block
    COUNTER = COUNTER+1;
    ...
    %% Image One
    % Display Image One
    DrawImageCenter(WSS, TI(4*i-3), DATA.ImageSizes{4*i-3});
    ...
    %% Image Two
    % Display Image Two
    DrawImageCenter(WSS, TI(4*i-2), DATA.ImageSizes{4*i-2});
    % Draw White Screen after 3 Seconds
    WaitSecs(2.5);
    DrawWhiteScreen(WSS, RSS);
    % Wait till Block
    ...
    %% Image Three
    % Display Image Two
    DrawImageCenter(WSS, TI(4*i-1), DATA.ImageSizes{4*i-1});
    % Draw White Screen after 3 Seconds
    WaitSecs(2.5);
    DrawWhiteScreen(WSS, RSS);
    % Wait till Block
    ...
    %% Image Four
    % Display Image Four
    DrawImageCenter(WSS, TI(4*i), DATA.ImageSizes{4*i});
    % Draw White Screen after 3 Seconds
    WaitSecs(2.5);
    DrawWhiteScreen(WSS, RSS);
    % Wait till Block
